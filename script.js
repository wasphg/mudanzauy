    ...
    products: [
      ...
      },
      {
        Info: {
          ...
          images: ["images/estufa_1.jpg", "images/estufa_2.jpg", "images/estufa_3.jpg"],
          title: "Estufa JAMES",
...
function createProductCard(product) {
    ...
    articleContainer.classList.add("style1")

    const spanContainer = document.createElement("span")
    spanContainer.classList.add("image")


    const productImage = document.createElement("img");
    productImage.src = product.Info.mainImage;
    productImage.alt = product.Info.title;
    spanContainer.appendChild(productImage);


    const myH = document.createElement("h2");
    myH.textContent = product.Info.title    

    const myDiv = document.createElement("div");
    myDiv.classList.add("content")

    const myDescription = document.createElement("p");
    myDescription.textContent = product.Info.price;
    myDiv.appendChild(myDescription);

    const refContainer = document.createElement("a")
    refContainer.href = "generic.html?productId="+product.Info.id
    refContainer.appendChild(myH)
    refContainer.appendChild(myDiv)

    articleContainer.appendChild(spanContainer)
    articleContainer.appendChild(refContainer)
 ...
 function displayProducts(products) {
    ...
    sectionContainer.classList.add("tiles")

    products.forEach(product => {
      const productCard = createProductCard(product);
      sectionContainer.appendChild(productCard);
    });
  ...
  document.addEventListener("DOMContentLoaded", function() {
    displayProducts(data_products.products);
  });
